...
if !exists("g:vimrc_loaded")
    ...
    if has("gui_running")
        ...
        colorscheme  desert_my "DarkMate  ron moria  murphy molokai default desert desert_my desertEx
    endif " has
endif " exists(...)
...
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
   ...
   """"""""""""""""""""""""""""""
   " winmanager setting  BufExplorer,FileExplorer|TagList
   """"""""""""""""""""""""""""""
  ...
  " autocmd BufWinEnter \[Buf\ List\] setl nonumber
   ...
   " mark setting
   """"""""""""""""""""""""""""""
   nmap <silent> gl <Plug>MarkSet
   vmap <silent> gl <Plug>MarkSet
   nmap <silent> gc <Plug>MarkClear
   vmap <silent> gc <Plug>MarkClear
   nmap <silent> gr <Plug>MarkRegex
   vmap <silent> gr <Plug>MarkRegex
...
set expandtab
set shiftwidth=6
au FileType html,python,vim,javascript setl shiftwidth=6
au FileType html,python,vim,javascript setl tabstop=6
au FileType java,php setl shiftwidth=6
au FileType java,php setl shiftwidth=6
set smarttab
set lbr
set tw=0
...
nmap fn :cs f f  
nmap ,f :cs f f  
nmap <F10> :botright cwindow 10<cr>
nmap <F11> [c
nmap <F12> ]c
nmap <C-z> :q<CR>
nmap <C-s> :w
